...
files = [
    ...
    'Uber_Duper_Simulation_Mathematica\\results_full.txt',
...
plot_bar('Тест производительности решения ОДУ\n(чем меньше, тем лучше)', [data[2] for data in total_data], languages,
         True)
...
plot_bar('Тест производительности решения ОДУ (dt = 0.01 с)\n(чем меньше, тем лучше)', [data[2] for data in total_data],
         languages, False)
