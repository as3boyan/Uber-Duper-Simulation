...
{
HX_STACK_FRAME("StringBuf","new",0xaaa8f4b4,"StringBuf.new","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",29,0xec7a1c49)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("StringBuf","add",0xaa9f1675,"StringBuf.add","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/StringBuf.hx",40,0xec7a1c49)
		HX_STACK_THIS(this)
		HX_STACK_ARG(x,"x")
		HX_STACK_LINE(41)
