...
{
HX_STACK_FRAME("haxe.ds.IntMap","new",0x7222c4b6,"haxe.ds.IntMap.new","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",28,0xa39a0aad)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(29)
...
{
		HX_STACK_FRAME("haxe.ds.IntMap","set",0x72268ff8,"haxe.ds.IntMap.set","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",33,0xa39a0aad)
		HX_STACK_THIS(this)
...
Dynamic IntMap_obj::get( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","get",0x721d74ec,"haxe.ds.IntMap.get","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",37,0xa39a0aad)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(37)
...
bool IntMap_obj::exists( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","exists",0x63ba0346,"haxe.ds.IntMap.exists","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",41,0xa39a0aad)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
...
bool IntMap_obj::remove( int key){
	HX_STACK_FRAME("haxe.ds.IntMap","remove",0xa86281ae,"haxe.ds.IntMap.remove","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",45,0xa39a0aad)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(45)
