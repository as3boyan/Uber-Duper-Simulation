...
{
HX_STACK_FRAME("haxe.io.Path","new",0x1b96d677,"haxe.io.Path.new","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",76,0x6851e367)
HX_STACK_THIS(this)
...
::String Path_obj::directory( ::String path){
	HX_STACK_FRAME("haxe.io.Path","directory",0xbcfe23c4,"haxe.io.Path.directory","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/haxe/io/Path.hx",141,0x6851e367)
	HX_STACK_ARG(path,"path")
	HX_STACK_LINE(142)
