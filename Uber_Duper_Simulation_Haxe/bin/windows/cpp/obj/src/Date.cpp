...
{
HX_STACK_FRAME("Date","new",0x9aa26240,"Date.new","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",26,0x12e80143)
HX_STACK_THIS(this)
...
Float Date_obj::getTime( ){
	HX_STACK_FRAME("Date","getTime",0x0cac7da3,"Date.getTime","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",31,0x12e80143)
	HX_STACK_THIS(this)
	HX_STACK_LINE(31)
...
::Date Date_obj::fromTime( Float t){
	HX_STACK_FRAME("Date","fromTime",0x44fd3cb7,"Date.fromTime","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",57,0x12e80143)
	HX_STACK_ARG(t,"t")
	HX_STACK_LINE(58)
...
::Date Date_obj::fromString( ::String s){
	HX_STACK_FRAME("Date","fromString",0x5ead97fb,"Date.fromString","D:\\Denis\\PortableSoft\\HaxeToolkit\\haxe\\std/cpp/_std/Date.hx",63,0x12e80143)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(64)
	{
		HX_STACK_LINE(64)
