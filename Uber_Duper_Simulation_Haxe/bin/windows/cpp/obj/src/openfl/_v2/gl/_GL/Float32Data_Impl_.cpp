...
Dynamic Float32Data_Impl__obj::_new( Dynamic data){
	HX_STACK_FRAME("openfl._v2.gl._GL.Float32Data_Impl_","_new",0x5a362ecc,"openfl._v2.gl._GL.Float32Data_Impl_._new","openfl/_v2/gl/GL.hx",1364,0x4b5f1ee2)
...
Array< Float > Float32Data_Impl__obj::toDynamic( Dynamic this1){
	HX_STACK_FRAME("openfl._v2.gl._GL.Float32Data_Impl_","toDynamic",0x6b67b9f9,"openfl._v2.gl._GL.Float32Data_Impl_.toDynamic","openfl/_v2/gl/GL.hx",1365,0x4b5f1ee2)
...
Dynamic Float32Data_Impl__obj::fromFloat32Array( ::openfl::_v2::utils::Float32Array f){
	HX_STACK_FRAME("openfl._v2.gl._GL.Float32Data_Impl_","fromFloat32Array",0x36ce6cd3,"openfl._v2.gl._GL.Float32Data_Impl_.fromFloat32Array","openfl/_v2/gl/GL.hx",1367,0x4b5f1ee2)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(1367)
...
Dynamic Float32Data_Impl__obj::fromArrayFloat( Array< Float > f){
	HX_STACK_FRAME("openfl._v2.gl._GL.Float32Data_Impl_","fromArrayFloat",0x08375c78,"openfl._v2.gl._GL.Float32Data_Impl_.fromArrayFloat","openfl/_v2/gl/GL.hx",1369,0x4b5f1ee2)
	HX_STACK_ARG(f,"f")
	HX_STACK_LINE(1369)
	return f;
}
