...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("", "UberDuperSimulationHaxe", "UberDuperSimulationHaxe", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Uber_Duper_Simulation_Haxe", null, { width: 800, height: 480 });
